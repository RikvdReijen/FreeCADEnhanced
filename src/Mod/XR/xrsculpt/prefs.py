...
# ***************************************************************************
"""Preference lookup for the sculpting subsystem.
...
*inside* the functions (ARCHITECTURE.md §6), exactly as in
:mod:`xrpaint.prefs`, so every module in this package stays unit-testable
without FreeCAD.
"""
...
DEFAULTS = {
    "SculptBrush": "draw",
    "SculptRadius": 0.05,          # metres, world scale
    "SculptStrength": 0.3,
    "SculptFalloff": "smooth",
    "SculptSpacing": 0.15,
    "SculptPressureEnabled": True,
    "SculptSymmetryX": False,
    "SculptSymmetryY": False,
    "SculptSymmetryZ": False,
    "SculptSymmetryTolerance": 1.0e-6,
    "SculptUndoSteps": 64,
    "SculptTessellation": 0.1,     # Part -> mesh deflection
    "SculptDynamicDetail": False,
    "SculptTargetEdge": 0.005,     # metres
}
